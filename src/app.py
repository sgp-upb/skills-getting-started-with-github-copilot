...
activities = {
    ...
    "Basketball Team": {
        "description": "Practice skills and compete in interschool basketball games",
        "schedule": "Tuesdays and Thursdays, 4:00 PM - 5:30 PM",
        "max_participants": 15,
        "participants": ["nathan@mergington.edu", "chloe@mergington.edu"]
    },
    "Swimming Club": {
    ...
    "Music Ensemble": {
        "description": "Rehearse music pieces and perform as a school ensemble",
